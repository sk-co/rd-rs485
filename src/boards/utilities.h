...
// *
// * \param [IN] buffer   Data buffer_ used to compute the CRC
// * \param [IN] length   Data buffer_ length
// *
// * \retval crc          The computed buffer_ of length CRC
// */
